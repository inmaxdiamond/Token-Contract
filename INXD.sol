...
//  Copyright (c) 2020 by INMAX DIAMOND Community (www.inmaxdiamond.com) 
...
contract ERC20Interface {
    ...
    // ------------------------------------------------------------------------
contract INXD is ERC20Interface{
    string public name = "INMAX Diamond";
    string public symbol = "INXD";
    ...
    event Approval(address indexed tokenOwner, address indexed spender, uint tokens);
    // ------------------------------------------------------------------------
    // Constructor With 12,000 supply, All deployed tokens sent to Main wallet
    // ------------------------------------------------------------------------
    constructor() public{
        supply = 12000000000;
        founder = msg.sender;
